...
<head>
	...
	<script type="text/javascript" src="js/plugin/scrollMagic/animation.gsap.min.js"></script>
	<script type="text/javascript" src="js/plugin/scrollMagic/debug.addIndicators.min.js"></script>
	<!--slidder -->
	<!-- <script src="dnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script> -->
...
?>
<div class="about_bigwrapper clearfix">
	<div class="about_bigwrapper_content">
	<!--關於果然 第一屏 車子出發 -->
	<section class="about_start clearfix">
		<div class="about_start_background_block cl-s-12">
			<img class="about_start_background_clould01" src="images/about/cloud(01).png" alt="cloud">
			<img class="about_start_background_clould03" src="images/about/cloud(03).png" alt="cloud">

			<div class="about_start_info_blcok">
				<div class="about_start_info_blcok_border">
					<div class="about_start_info_item_title">
						<img src="images/about/aboutUs.png" alt="farmerFlag">
					</div>
					<div class="about_start_formInfo">
						<p class="about_start_formInfo_content">
							說到果汁，你會想到什麼呢？不外乎是加水、加糖、加香精的飲品，且多半是在夜市、路邊攤等處販售的，對吧？！
							果然配有別於一般的市售果汁，消費者不但可以直接在果然的官方網站製作專屬於自己的果汁，可以挑選3種水果還能依照自己喜歡的比例做調整，果然配強調100%水果原汁，亦即不加水、不加糖、不加人工添加物的現作果汁。
						</p>
					</div>
				</div>
			</div> 

			<!-- <div class="about_start_content_car01">
				<img src="images/about/car(noTire).png" alt="car">
			</div>
			<div class="about_start_content_car01_tire1">
				<img src="images/about/tire.png" alt="tire">
			</div>
			<div class="about_start_content_car01_tire2">
				<img src="images/about/tire.png" alt="tire">
			</div> -->
	
			<div class="about_start_content_mountain03">
				<img src="images/about/mountain(03).png" alt="mountain">
			</div>
			<div class="about_start_content_bounce">
				<img src="images/about/starting point.png" alt="farmer">
				<img src="images/about/step-01.png" alt="step">
			</div>
			<div class="about_start_content_orchard">
				<img src="images/about/orchard.png" alt="orchard">
			</div>
			<div class="about_start_content_fence1">
				<img src="images/about/Fence.png" alt="fence">
			</div>
			<div class="about_start_content_barn">
				<img src="images/about/Barn.png" alt="barn">
			</div>
			<div class="about_start_content_fence2">
				<img src="images/about/Fence.png" alt="fence">
			</div>
			<div class="about_start_content_mountain01">
				<img src="images/about/mountain(04).png" alt="mountain">
			</div>
			<div class="about_start_content_mountain02">
				<img src="images/about/mountain(05).png" alt="mountain">
			</div>
			<div class="about_start_content_flower1">
				<img src="images/about/Flower.png" alt="flower">
			</div>
			<div class="about_start_content_flower2">
				<img src="images/about/Flower.png" alt="flower">
			</div>
			<div class="about_start_content_flower3">
					<img src="images/about/Flower.png" alt="flower">
				</div>
			<div class="about_start_grass">
				<div class="about_start_road01">
					<img src="images/about/roud01.png" alt="road">
				</div>
				<div class="about_start_road02">
					<img src="images/about/roud01.png" alt="road">
				</div>
			</div>
		</div>
	...
	<!--製作裝箱 第二屏 ru-->
	<section class="about_factory clearfix">
		<div class="about_factory_background_block cl-s-12">
			<img class="about_factory_background_clould01" src="images/about/cloud(01).png" alt="cloud">
			<img class="about_factory_background_clould03" src="images/about/cloud(03).png" alt="cloud">

			 <div class="about_factory_grass_background">
				<div class="about_factory_info_blcok">
					<div class="about_factory_bird">
						<img src="images/about/bird.png" alt="bird">
					</div>
					<div class="about_factory_info_blcok_border">
						<div class="about_factory_info_item_title">
							<img src="images/about/farmer_flag.png" alt="farmerFlag">
						</div>
						<div class="about_factory_info_item_truck_horizontal">
							<img src="images/about/truck_horizontal line.png" alt="truck">
						</div>
						<div class="about_factory_info_item_farmer">
							<img src="images/about/farmer.png" alt="farmer">
						</div>

						<div class="about_factory_info_item_cart_straight">
							<img src="images/about/cart_straight line.png" alt="cart">
						</div>
						<div class="about_factory_info_item_truck_straight">
							<img src="images/about/truck_straight line.png" alt="truck">
						</div>

						<div class="about_factory_info_item_logo">
							<img src="images/about/logopay.png" alt="logo">
						</div>
						<div class="about_factory_info_item_cart_horizontal">
							<img src="images/about/cart_horizontal line.png" alt="truck">
						</div>
					</div>
				</div>
			</div> 
			<div class="about_factory_content_factoryTitle bounce">
				<img id="farmerLocationIcon" src="images/about/mid point.png" alt="factoryIcon">
				<img src="images/about/step-02.png" alt="製作裝箱">
			</div>
			...
			<!-- <div class="about_factory_content_car01">
				<img src="images/about/car(01).png" alt="car">
			</div> -->

			<div class="about_factory_content_streetlamp1">
				<img src="images/about/Street light.png" alt="streetlamp">
			</div>
			<div class="about_factory_content_streetlamp2">
					<img src="images/about/Street light.png" alt="streetlamp">
			</div>
			<div class="about_factory_content_streetlamp3">
					<img src="images/about/Street light.png" alt="streetlamp">
			</div>
			<div class="about_factory_content_roadsign">
				<img src="images/about/RoadSign.png" alt="roadsign">
				<img src="images/about/Grass(01).png" alt="grass">
			</div>		
			<div class="about_factory_content_mountain01">
				<img src="images/about/mountain02.png" alt="mou">
			</div>
			<div class="about_factory_content_mountain02">
				<img src="images/about/mountain(03).png" alt="mountain">
			</div>
			<div class="about_factory_content_grass1">
				<img src="images/about/Grass(01).png" alt="grass">
			</div>
	
			<div class="about_factory_content_factory">
				<img src="images/about/Factory.png" alt="factory">
			</div>
			<div class="about_factory_content_pine">
				<img src="images/about/tree03.png" alt="pine">
			</div>

			<div class="about_factory_grass">
				<div class="about_factory_road1">
					<img src="images/about/Asphaltroad01.png" alt="road">
				</div>
				<div class="about_factory_road2">
					<img src="images/about/Asphaltroad01.png" alt="road">
					</div>
			</div>
		</div>
...
<div id="app">
	...
	<section class="about_end ">
		...
		<div class="about_end_background_stop">
			<img src="images/about/stop.png" alt="stopsign">
		</div>
		<div class="about_end_background_soil">
				<div class="about_end_background_soil_road1">
					<img src="images/about/Asphaltroad01.png" alt="road">
				</div>
				<div class="about_end_background_soil_road2">
					<img src="images/about/Asphaltroad01.png" alt="road">
				</div>
				<div class="about_end_background_soil_road3">
					<img src="images/about/Asphaltroad01.png" alt="road">
				</div> 
		</div>
	...
	<div class="about_truck">
		<img src="images/about/car.png" alt="car">
	</div>
</div>
			<script src="js/realtaiwan.js"></script>
			<script>
					$(function() {
				  ...
				  .to(".about_bigwrapper_content", 1, { x: "-20%" })
				  .to(".about_bigwrapper_content", 1, { x: "-40%" })
				  .to(".about_bigwrapper_content", 1, { x: "-60%" })
				  .to(".about_bigwrapper_content", 1, { x: "-75%" });
				
				  // create scene to pin and link animation
				  new ScrollMagic.Scene({
					triggerElement: ".about_bigwrapper",
					triggerHook: "onLeave",
					duration: "400%"
				  })
					.setPin(".about_bigwrapper")
